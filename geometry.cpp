...
const VertexFormat VertexPNCRX::FORMAT =
VertexFormat(sizeof(VertexPNCRX))
    .put("aPosition", 3, GL_FLOAT, GL_FALSE, offsetof(VertexPNX, p))
    .put("aNormal", 3, GL_FLOAT, GL_FALSE, offsetof(VertexPNX, n))
    .put("aCentroid", 3, GL_FLOAT, GL_FALSE, offsetof(VertexPNCRX, c))
    .put("aLocalPos", 3, GL_FLOAT, GL_FALSE, offsetof(VertexPNCRX, r))
    .put("aTexCoord", 2, GL_FLOAT, GL_FALSE, offsetof(VertexPNX, x));
