...
class Uniforms {
  public:
    ...
    Uniforms &put(const std::string &name, const shared_ptr<Texture> &value) {
    ...
    Uniforms &put(const std::string &name, const shared_ptr<Texture> *values,
                  int count) {
  ...
  protected:
    ...
    class Value {
      public:
        ...
        virtual const shared_ptr<Texture> *getTextures() const { return NULL; };
    ...
    class TexturesValue : public Value {
        std::vector<shared_ptr<Texture>> texs_;

      public:
        TexturesValue(const shared_ptr<Texture> *tex, int size)
        ...
        virtual const shared_ptr<Texture> *getTextures() const {
            return &texs_[0];
        }
    };
};
